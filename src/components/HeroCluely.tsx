        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center min-h-[85vh] sm:min-h-[90vh] lg:min-h-[80vh]">
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-6 sm:pt-8 border-t border-gray-100">
              ...
              <div className="text-center lg:text-left">
                <div className="heading-4 text-green-600">600M</div>
                <div className="body-small text-gray-600">Patients across Singapore and ASEAN countries</div>
              </div>
              <div className="text-center lg:text-left">
          ...
          <div className="hero-visual relative mt-8 lg:mt-0">
            <div className="relative">
              ...
              {/* Interface Image */}
              <div ref={illustrationRef} className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
                <Image 
                  src="/Interface.png" 
                ...
                {/* Floating indicators */}
                <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-6 h-6 sm:w-8 sm:h-8 bg-green-500 rounded-full flex items-center justify-center animate-pulse">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                </div>
                
                <div className="absolute -bottom-1 -left-1 sm:-bottom-2 sm:-left-2 w-5 h-5 sm:w-6 sm:h-6 bg-green-500 rounded-full flex items-center justify-center">
